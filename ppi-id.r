  ...
  tabsetPanel(
    tabPanel("Predict from Accession",
             sidebarLayout(
               sidebarPanel(
                 ...
                 tags$span("Select for each protein if you would like to fetch domain or motif information. PPID can predict domain-domain interactions or domain-motif interactions (at least one protein must have 'Domain' selected).", 
    ...
    tabPanel("About",
             ...
             p("PPI-ID contains a number of features that facilitates structural analysis of pdb files produced by AlphaFold.
               ...
               interest and the reversion of the molecular model to its original state."),
             HTML('<p>
                  <a href="https://youtu.be/0ESc9fISfgk" target="_blank">Click here</a>
             to access a video demonstration on how to use PPI-ID.
             </p>'),
