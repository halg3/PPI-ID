...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("About",
             h3("About"),
             p("This is a structural bioinformatics tool that aids domain-domain or domain-motif
             interaction prediction between proteins. This tool was designed to help researchers refine inputted
             amino acid sequences when predicting protein-protein interactions using AlphaFold Multimer, and this 
             tool can also help researchers identify interacting protein regions, as found in a PDB file. To use, 
